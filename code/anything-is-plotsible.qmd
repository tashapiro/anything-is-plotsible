...
# Let me introduce you to some of my favorite R packages...
...
::: columns
::: {.column width="50%"}
![[Basel, Switzerland](https://github.com/tashapiro/30DayMapChallenge/blob/main/2021/basel-openstreetmap/basel_map.R) map created with `ggplot2`, `sf`, and `osm`. Part of the #30DayMapChallenge.](images/map-basel.jpeg){fig-align="center" width="80%"}
:::
